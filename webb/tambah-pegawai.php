  ...
  <font face="calibri" bold>
    ...
    <div class="box" align="">
      ...
      <h4>TAMBAH PEGAWAI</h4><br>
        ...
        <table>
        <tr><td>Nama</td><td>
        <input type="text" name="nama" class="form-control" placeholder="" required></td></tr>
      </div>

      <div class="form-group">
        <tr><td>Username</td><td>
        <input type="text" name="user" class="form-control" placeholder="" required></td></tr>
      </div>
